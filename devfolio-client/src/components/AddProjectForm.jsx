...
export default function AddProjectForm({
  ...
  const onSubmit = async (e) => {
    e.preventDefault();
    if (!githubOk) {
      alert("GitHub must be a profile or repo URL (e.g. https://github.com/you or https://github.com/you/repo)");
      return;
    }
    if (!linkedinOk) {
        ...
        <form onSubmit={onSubmit} className="space-y-3">
          ...
          <div>
            ...
            <input
              ...
              className={`w-full border p-2 rounded focus:outline-none focus:ring-2 ${
                demoOk ? "focus:ring-blue-500" : "focus:ring-red-500 border-red-400"
              }`}
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={handleChange}
              className={`w-full border p-2 rounded focus:outline-none focus:ring-2 ${
                linkedinOk ? "focus:ring-blue-500" : "focus:ring-red-500 border-red-400"
              }`}
            />
          </div>
